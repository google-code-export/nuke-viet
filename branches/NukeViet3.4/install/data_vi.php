...
if ($db->sql_numrows($result))
{
    ...
    $sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_tags_con_1` (`module`, `sid`, `link`, `title`, `text`, `image`) VALUES
		...
		('news', 6, 'Doi-tac/Thu-moi-hop-tac-6', 'Thư mời hợp tác liên kết quảng cáo và cung cấp hosting thử nghiệm', 'Hiện tại VINADES.,JSC đang tiến hành phát triển bộ mã nguồn NukeViet phiên bản 3.0 – một thế hệ CMS hoàn toàn mới với nhiều tính năng ưu việt, được đầu tư bài bản với kinh phí lớn. Với thiện chí hợp tác cùng phát triển VINADES.,JSC xin trân trọng gửi lời mời hợp tác đến Quý đối tác là các công ty cung cấp tên miền - hosting, các doanh nghiệp quan tâm và mong muốn hợp tác cùng VINADES để cùng thực hiện chung các hoạt động kinh doanh nhằm gia tăng giá trị, quảng bá thương hiệu chung cho cả hai bên.', 'files/news/thumb/hoptac.jpg'),
